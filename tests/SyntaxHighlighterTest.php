...
class SyntaxHighlighterTest extends TestCase
{
    ...
    public function testSyntaxHighligherParser()
    {
        ...
        $expected = '<preclass="textpre_code"style="font-family:monospace;"><ol><listyle="font-weight:normal;vertical-align:top;font-size:14px"><divstyle="font:normalnormal1em/1.2emmonospace;margin:0;padding:0;background:none;vertical-align:top;">ExampleText</div></li></ol></pre>';
